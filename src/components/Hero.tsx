...
<section
  id="hero"
  className="relative min-h-screen flex items-center lg:justify-center justify-start pt-20 px-6 overflow-hidden"
>
  {/* Background */}
  <div className="absolute inset-0 z-0">
    <div
  ...
  <div className="container mx-auto relative z-10">
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      <motion.div
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.8, ease: "easeOut" }}
        className="space-y-6 text-left"  // ⬅️ MOBILE LEFT ALIGN
      >
        <motion.p
          className="text-sm uppercase tracking-widest text-accent font-semibold"
        >
        ...
        <motion.p className="text-lg md:text-xl text-muted-foreground max-w-lg font-medium">
          Crafting premium digital experiences through bold design and seamless
          functionality.
        </motion.p>

        {/* BUTTONS — ALWAYS HORIZONTAL */}
        <motion.div className="flex flex-row flex-wrap gap-4 pt-4">
          <button
            onClick={() => scrollToSection("projects")}
            className="btn-hero group"
          >
          ...
          <a
            href="https://wa.me/923272707907?text=Hi%20Muhammad%20Ibrahim"
            target="_blank"
            className="inline-flex items-center justify-center rounded-xl px-8 py-4 text-sm font-semibold border-2 border-border hover:border-accent hover:bg-secondary transition-all duration-300"
          >
            <img src="/wa business logo.png" className="w-5 h-5 mr-2 dark:hidden" />
            <img src="/wa business white.png" className="w-5 h-5 mr-2 hidden dark:inline" />
            Contact Me
          </a>
        </motion.div>
      </motion.div>
      ...
      >
        <div className="relative w-[85%] md:w-[70%] lg:w-full max-w-lg aspect-square">
